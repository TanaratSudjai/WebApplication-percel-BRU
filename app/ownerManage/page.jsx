...
const HelloOwnerPage = () => {
  ...
  const handleReceiver = (id) => {
    const parcel = parcelData1.dataParcel.find((parcel) => parcel.par_id === id);
      ...
      <div className="dashboard-container rounded-xl border-2 shadow-md p-4 bg-white">
        ...
        <div className="table-container h-[500px] overflow-y-auto">
          <table className="data-table min-w-full border-collapse">
            ...
            <tbody>
              {parcelData.parcelOwner && parcelData.parcelOwner.map((parcel) => (
                <tr key={parcel.par_id} className="even:bg-gray-50 text-center">
                  ...
                  <td className="px-4 py-2 border">{parcel.Owner.own_name}</td>
                  <td className="px-4 py-2 border">{parcel.Owner.own_phone}</td>
                  <td className="px-4 py-2 border">
